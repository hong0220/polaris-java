...
public final class RateLimitGRPCV2Grpc {
  ...
  private static volatile io.grpc.MethodDescriptor<RatelimitV2.RateLimitRequest,
      RatelimitV2.RateLimitResponse> getServiceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Service",
      requestType = RatelimitV2.RateLimitRequest.class,
      responseType = RatelimitV2.RateLimitResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<RatelimitV2.RateLimitRequest,
      RatelimitV2.RateLimitResponse> getServiceMethod() {
    io.grpc.MethodDescriptor<RatelimitV2.RateLimitRequest, RatelimitV2.RateLimitResponse> getServiceMethod;
      ...
      synchronized (RateLimitGRPCV2Grpc.class) {
        if ((getServiceMethod = RateLimitGRPCV2Grpc.getServiceMethod) == null) {
          RateLimitGRPCV2Grpc.getServiceMethod = getServiceMethod =
              io.grpc.MethodDescriptor.<RatelimitV2.RateLimitRequest, RatelimitV2.RateLimitResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Service"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  RatelimitV2.RateLimitRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  RatelimitV2.RateLimitResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<RatelimitV2.TimeAdjustRequest,
      RatelimitV2.TimeAdjustResponse> getTimeAdjustMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "TimeAdjust",
      requestType = RatelimitV2.TimeAdjustRequest.class,
      responseType = RatelimitV2.TimeAdjustResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<RatelimitV2.TimeAdjustRequest,
      RatelimitV2.TimeAdjustResponse> getTimeAdjustMethod() {
    io.grpc.MethodDescriptor<RatelimitV2.TimeAdjustRequest, RatelimitV2.TimeAdjustResponse> getTimeAdjustMethod;
      ...
      synchronized (RateLimitGRPCV2Grpc.class) {
        if ((getTimeAdjustMethod = RateLimitGRPCV2Grpc.getTimeAdjustMethod) == null) {
          RateLimitGRPCV2Grpc.getTimeAdjustMethod = getTimeAdjustMethod =
              io.grpc.MethodDescriptor.<RatelimitV2.TimeAdjustRequest, RatelimitV2.TimeAdjustResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "TimeAdjust"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  RatelimitV2.TimeAdjustRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  RatelimitV2.TimeAdjustResponse.getDefaultInstance()))
  ...
  public static abstract class RateLimitGRPCV2ImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<RatelimitV2.RateLimitRequest> service(
        io.grpc.stub.StreamObserver<RatelimitV2.RateLimitResponse> responseObserver) {
     ...
     * </pre>
     */
    public void timeAdjust(RatelimitV2.TimeAdjustRequest request,
        io.grpc.stub.StreamObserver<RatelimitV2.TimeAdjustResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncBidiStreamingCall(
              new MethodHandlers<
                RatelimitV2.RateLimitRequest,
                RatelimitV2.RateLimitResponse>(
                  this, METHODID_SERVICE)))
          .addMethod(
            getTimeAdjustMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                RatelimitV2.TimeAdjustRequest,
                RatelimitV2.TimeAdjustResponse>(
  ...
  public static final class RateLimitGRPCV2BlockingStub extends io.grpc.stub.AbstractBlockingStub<RateLimitGRPCV2BlockingStub> {
     ...
     * </pre>
     */
    public RatelimitV2.TimeAdjustResponse timeAdjust(RatelimitV2.TimeAdjustRequest request) {
  ...
  public static final class RateLimitGRPCV2FutureStub extends io.grpc.stub.AbstractFutureStub<RateLimitGRPCV2FutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<RatelimitV2.TimeAdjustResponse> timeAdjust(
        RatelimitV2.TimeAdjustRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_TIME_ADJUST:
          serviceImpl.timeAdjust((RatelimitV2.TimeAdjustRequest) request,
              (io.grpc.stub.StreamObserver<RatelimitV2.TimeAdjustResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class RateLimitGRPCV2BaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return GrpcapiV2Metric.getDescriptor();
    }
